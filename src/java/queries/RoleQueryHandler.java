...
public class RoleQueryHandler implements QueryHandler {
    ...
    private static final String INSERT_DATA_QUERY = "INSERT INTO `roles`(`id`, `weight`) VALUES (?, ?)";
    private static final String UPDATE_DATA_QUERY = "";
    private static final String DELETE_DATA_QUERY = "DELETE FROM `roles` WHERE `id`= ?";
