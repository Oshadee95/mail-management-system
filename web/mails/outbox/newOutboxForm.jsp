                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="card card-inverse">
                                ...
                                <form class="form-validate" method="POST" action="<%=request.getContextPath()%>/Mails/Outbox/103">
                                    <div class="card-block">
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <textarea style="background-color: white" rows="4" cols="5" class="form-control" name="reply"></textarea>
                                                </div>
                                            </div>
                                        </fieldset>
