...
public class MessageConfig {
    ...
    private static final String CATEGORY_ADD_ERROR_LOCAL = "Failed to register category.<br>";
    ...
    private static final String CATEGORY_UPDATE_ERROR_LOCAL = "Failed to update category.<br>";
    ...
    private static final String CATEGORY_ROUTE_LOCAL = "Failed to open category route.<br>";
    public static final String CATEGORY_ERROR_2004 = "ECODE : 2004 | Failed to open route " + Route.DISPLAY_CATEGORIES_ROUTE;
    public static final String CATEGORY_ERROR_2004_LOCAL = CATEGORY_ROUTE_LOCAL + "Contact system administrator. ECODE - 2004";
    public static final String CATEGORY_ERROR_2005 = "ECODE : 2005 |  Failed to open route " + Route.DISPLAY_CATEGORY_UPDATE_FORM_ROUTE;
    public static final String CATEGORY_ERROR_2005_LOCAL = CATEGORY_ROUTE_LOCAL + "Contact system administrator. ECODE - 2005";
    ...
    private static final String OCCUPATION_ADD_ERROR_LOCAL = "Failed to register occupation.<br>";
    public static final String OCCUPATION_ERROR_2008 = "ECODE : 2008 | Failed to register occupation due to sql error";
    public static final String OCCUPATION_ERROR_2008_LOCAL = OCCUPATION_ADD_ERROR_LOCAL + "Contact system administrator. ECODE - 2008";
    public static final String OCCUPATION_ERROR_2009 = "ECODE : 2009 | Failed to register occupation due to missing values";
    public static final String OCCUPATION_ERROR_2009_LOCAL = OCCUPATION_ADD_ERROR_LOCAL + "Reqired values are missing, Please make sure all required feilds are filled";

    private static final String OCCUPATION_UPDATE_ERROR_LOCAL = "Failed to update category.<br>";
    public static final String OCCUPATION_ERROR_2010 = "ECODE : 2010 | Failed to update occupation due to sql error";
    public static final String OCCUPATION_ERROR_2010_LOCAL = OCCUPATION_UPDATE_ERROR_LOCAL + "Contact system administrator. ECODE - 2010";
    public static final String OCCUPATION_ERROR_2011 = "ECODE : 2011 | Failed to update occupation due to missing values";
    public static final String OCCUPATION_ERROR_2011_LOCAL = OCCUPATION_UPDATE_ERROR_LOCAL + "Reqired values are missing, Please make sure all required feilds are filled";

    private static final String OCCUPATION_ROUTE_LOCAL = "Failed to open occupation route.<br>";
    public static final String OCCUPATION_ERROR_2012 = "ECODE : 2012 | Failed to open route " + Route.DISPLAY_OCCUPATIONS_ROUTE;
    public static final String OCCUPATION_ERROR_2012_LOCAL = OCCUPATION_ROUTE_LOCAL + "Contact system administrator. ECODE - 2012";
    ...
    public static final String OCCUPATION_ERROR_2013_LOCAL = OCCUPATION_ROUTE_LOCAL + "Contact system administrator. ECODE - 2013";
    ...
    private static final String INBOX_ADD_ERROR_LOCAL = "Failed to register mail.<br>";
    public static final String INBOX_ERROR_2014 = "ECODE : 2014 | Failed to register mail due to sql error";
    public static final String INBOX_ERROR_2014_LOCAL = INBOX_ADD_ERROR_LOCAL + "Contact system administrator. ECODE - 2014";
    public static final String INBOX_ERROR_2015 = "ECODE : 2015 | Failed to register mail due to image upload error";
    public static final String INBOX_ERROR_2015_LOCAL = INBOX_ADD_ERROR_LOCAL + "Contact system administrator. ECODE - 2015";
    public static final String INBOX_ERROR_2016 = "ECODE : 2016 | Failed to register mail due to missing values";
    public static final String INBOX_ERROR_2016_LOCAL = INBOX_ADD_ERROR_LOCAL + "Reqired values are missing, Please make sure all required feilds are filled";

    private static final String INBOX_UPDATE_ERROR_LOCAL = "Failed to update mail.<br>";
    ...
    private static final String INBOX_ROUTE_LOCAL = "Failed to open mail route.<br>";
    public static final String INBOX_ERROR_2020 = "ECODE : 2020 | Failed to open route " + Route.DISPLAY_INBOX_ROUTE;
    public static final String INBOX_ERROR_2020_LOCAL = INBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2020";
    public static final String INBOX_ERROR_2021 = "ECODE : 2021 |  Failed to open route " + Route.DISPLAY_INBOX_UPDATE_FORM_ROUTE;
    public static final String INBOX_ERROR_2021_LOCAL = INBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2021";
    public static final String INBOX_ERROR_2022_LOCAL = INBOX_ROUTE_LOCAL + "Uploaded image type is not supported";
    public static final String INBOX_ERROR_2023 = "ECODE : 2023 |  Failed to open route " + Route.DISPLAY_REGISTER_INBOX_FORM_ROUTE;
    public static final String INBOX_ERROR_2023_LOCAL = INBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2023";
    ...
    private static final String OUTBOX_ADD_ERROR_LOCAL = "Failed to reply mail.<br>";
    ...
    private static final String OUTBOX_UPDATE_ERROR_LOCAL = "Failed to update mail reply.<br>";
    ...
    private static final String OUTBOX_ROUTE_LOCAL = "Failed to open mail route.<br>";
    public static final String OUTBOX_ERROR_2031 = "ECODE : 2032 | Failed to open route " + Route.DISPLAY_OUTBOX_FORM_ROUTE;
    public static final String OUTBOX_ERROR_2031_LOCAL = OUTBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2020";
    public static final String OUTBOX_ERROR_2032 = "ECODE : 2032 |  Failed to open route " + Route.DISPLAY_OUTBOX_UPDATE_FORM_ROUTE;
    public static final String OUTBOX_ERROR_2032_LOCAL = OUTBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2021";
    public static final String OUTBOX_ERROR_2033 = "ECODE : 2033 |  Failed to open route " + Route.DISPLAY_REGISTER_OUTBOX_FORM_ROUTE;
    public static final String OUTBOX_ERROR_2033_LOCAL = OUTBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2023";
    ...
    public static final String OUTBOX_ERROR_2034_LOCAL = OUTBOX_ROUTE_LOCAL + "Contact system administrator. ECODE - 2034";

    // Users messages
    public static final String USER_OPERATION_NOTIFICATION_TITLE = "USER OPERATION";
    public static final String USER_OPERATION_SUCCESSFUL = "US-OP | SUCCESS";
    public static final String USER_OPERATION_FAILED = "US-OP | FAILED";
    public static final String USER_SUCCESSFUULY_ADDED = "New user was added.";
    public static final String USER_SUCCESSFUULY_ADDED_NOTIFICATION = "User registered successfully";
    public static final String USER_SUCCESSFUULY_UPDATED = "User was updated.";
    public static final String USER_SUCCESSFUULY_UPDATED_NOTIFICATION = "User successfully updated";

    private static final String USER_ADD_ERROR_LOCAL = "Failed to register user.<br>";
    public static final String USER_ERROR_2035 = "ECODE : 2035 | Failed to user due to sql error";
    public static final String USER_ERROR_2035_LOCAL = USER_ADD_ERROR_LOCAL + "Contact system administrator. ECODE - 2035";
    public static final String USER_ERROR_2036 = "ECODE : 2036 | Failed to user due to image upload error";
    public static final String USER_ERROR_2036_LOCAL = USER_ADD_ERROR_LOCAL + "Contact system administrator. ECODE - 2036";
    public static final String USER_ERROR_2037 = "ECODE : 2037 | Failed to user due to missing values";
    public static final String USER_ERROR_2037_LOCAL = USER_ADD_ERROR_LOCAL + "Reqired values are missing, Please make sure all required feilds are filled";
    public static final String USER_ERROR_2038_LOCAL = USER_ADD_ERROR_LOCAL + "Uploaded image type is not supported";

    private static final String USER_UPDATE_ERROR_LOCAL = "Failed to update user.<br>";
    public static final String USER_ERROR_2039 = "ECODE : 2039 | Failed to update user due to sql error";
    public static final String USER_ERROR_2039_LOCAL = USER_UPDATE_ERROR_LOCAL + "Contact system administrator. ECODE - 2039";
    public static final String USER_ERROR_2040 = "ECODE : 2040 | Failed to update user due to image upload error";
    public static final String USER_ERROR_2040_LOCAL = USER_UPDATE_ERROR_LOCAL + "Contact system administrator. ECODE - 2041";
    public static final String USER_ERROR_2041 = "ECODE : 2041 | Failed to update user due to missing values";
    public static final String USER_ERROR_2042_LOCAL = USER_UPDATE_ERROR_LOCAL + "Reqired values are missing, Please make sure all required feilds are filled";
    public static final String USER_ERROR_2043_LOCAL = USER_UPDATE_ERROR_LOCAL + "Uploaded image type is not supported";

    private static final String USER_ROUTE_LOCAL = "Failed to open user route.<br>";
    public static final String USER_ERROR_2044 = "ECODE : 2044 | Failed to open route " + Route.DISPLAY_USERS_ROUTE;
    public static final String USER_ERROR_2044_LOCAL = USER_ROUTE_LOCAL + "Contact system administrator. ECODE - 2044";
    public static final String USER_ERROR_2045 = "ECODE : 2045 | Failed to open route " + Route.DISPLAY_USERS_FORM_ROUTE;
    public static final String USER_ERROR_2045_LOCAL = USER_ROUTE_LOCAL + "Contact system administrator. ECODE - 2045";
    public static final String USER_ERROR_2046 = "ECODE : 2046 |  Failed to open route " + Route.DISPLAY_REGISTER_USER_FORM_ROUTE;
    public static final String USER_ERROR_2046_LOCAL = USER_ROUTE_LOCAL + "Contact system administrator. ECODE - 2046";
    public static final String USER_ERROR_2047 = "ECODE : 2047 |  Failed to open route " + Route.DISPLAY_USER_UPDATE_FORM_ROUTE;
    public static final String USER_ERROR_2047_LOCAL = USER_ROUTE_LOCAL + "Contact system administrator. ECODE - 2047";
}
