                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-5">
                            <div class="card card-inverse">
                                ...
                                <div class="card-block">
                                    <form class="form-validate" method="POST" action="<%=request.getContextPath()%>/Mails/Outbox/105" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-lg-4" style="font-size: 14px !important">Replied updated time </label>
                                                <div class="col-lg-8">
                                            ...
                                            <div class="float-right  m-t-40 m-b-20">
                                                ...
                                                <button type="submit" name="rUFrom" class="btn btn-md btn-warning"><i class="icon-reply  position-left"></i>reply</button>
                                            </div>
                                        </fieldset>
                                    </form>
                                </div>
