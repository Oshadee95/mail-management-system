                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="card card-inverse">
                            ...
                            <form class="form-validate" method="POST" action="<%=request.getContextPath()%>/Mails/Inbox/105" enctype="multipart/form-data">
                                <% InboxInfo inbox = (InboxInfo)request.getSession().getAttribute("selectedMail"); %>
                                <div class="card-block">
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" readonly value="<%=(inbox.getReplied().equals(true))? "Replied" : "Not replied"%>">
                                            </div>
                                        </div>
