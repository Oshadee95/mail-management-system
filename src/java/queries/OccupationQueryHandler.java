...
public class OccupationQueryHandler implements QueryHandler {
    ...
    private static final String INSERT_DATA_QUERY = "INSERT INTO `occupations`(`title`) VALUES (?)";
    private static final String UPDATE_DATA_QUERY = "";
    private static final String DELETE_DATA_QUERY = "DELETE FROM `occupations` WHERE `id`= ?";
