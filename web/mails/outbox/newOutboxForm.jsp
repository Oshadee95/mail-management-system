                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-5">
                            <div class="card card-inverse">
                                ...
                                <div class="card-block">
                                    <form class="form-validate" method="POST" action="<%=request.getContextPath()+Route.REGISTER_OUTBOX_ROUTE%>" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row m-t-40">
                                                ...
                                                <div class="col-lg-8">
                                                    <input style="background-color: white; " type="file" name="reply" required class="form-control " accept="image/x-png,image/jpeg">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-lg-4 d-font">Replied time </label>
                                                <div class="col-lg-8">
                                            ...
                                            <div class="float-right  m-t-40 m-b-20">
                                                ...
                                                <button type="submit" name="rForm" class="btn btn-md btn-primary d-font"><i class="icon-reply  position-left"></i> reply</button>
                                            </div>
                                        </fieldset>
                                    </form>
                                </div>
